...
const CATEGORY_TYPE = "pathology_test_category";
...
export function PathologyTestCategoryEntryPage() {
  ...
  const loadCategories = async () => {
    ...
    try {
      ...
      setErrorMessage(error.message || "Failed to load pathology test categories");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setErrorMessage(error.message || "Failed to save pathology test category");
    } finally {
      setIsSaving(false);
    }
  };
  ...
  const handleDelete = async (category) => {
    ...
    try {
      ...
      setErrorMessage(error.message || "Failed to delete pathology test category");
    }
  };
  ...
  const exportCsv = () => {
    ...
    link.href = url;
    link.download = "pathology-test-categories.csv";
    link.click();
