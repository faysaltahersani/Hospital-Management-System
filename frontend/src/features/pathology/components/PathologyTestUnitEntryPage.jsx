...
const UNIT_TYPE = "pathology_test_unit";
...
export function PathologyTestUnitEntryPage() {
  ...
  const loadUnits = async () => {
    ...
    try {
      ...
      setErrorMessage(error.message || "Failed to load pathology test units");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setErrorMessage(error.message || "Failed to save pathology test unit");
    } finally {
      setIsSaving(false);
    }
  };
  ...
  const handleDelete = async (unit) => {
    ...
    try {
      ...
      setErrorMessage(error.message || "Failed to delete pathology test unit");
    }
  };
  ...
  const exportCsv = () => {
    ...
    link.href = url;
    link.download = "pathology-test-units.csv";
    link.click();
