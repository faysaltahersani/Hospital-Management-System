...
import { financeSections } from "../data/financeData";
import { financeRoutes } from "../data/financeRoutes";

function FinancePanel({ items, title }) {
    ...
    <section className="mx-auto max-w-[1240px] pt-[2px]">
      ...
      <div className="mx-auto grid max-w-[860px] grid-cols-[360px_300px] justify-center gap-x-8 gap-y-6 max-md:grid-cols-1">
        {financeSections.map((section) => (
          <FinancePanel key={section.title} {...section} />
        ))}
      </div>
    </section>
  );
