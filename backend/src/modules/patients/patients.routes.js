...
const { requireSensitiveDataPermission } = require('../../middlewares/permission.middleware');
...
router.get('/:id/timeline', authorize(STAFF), requireSensitiveDataPermission('patients'), validate(schemas.timeline), controller.getTimeline);
